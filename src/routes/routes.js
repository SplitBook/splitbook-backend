...
routes.put('/teachers/:id', TeachersValidator.update, TeachersController.update)
routes.delete(
  '/teachers/:id',
...
routes.put('/students/:id', StudentsValidator.update, StudentsController.update)
routes.delete(
  '/students/:id',
...
routes.delete('/resumes/:id', ResumesValidator.delete, ResumesController.delete)
...
routes.put('/accounts/:id', AccountsValidator.update, AccountsController.update)
routes.delete(
  '/accounts/:id',
...
routes.delete('/reports/:id', ReportsValidator.delete, ReportsController.delete)
